...
@section('content')
        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-2 col-sm-4 tile_stats_count">
            ...
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-spinner"></i> Remaining</span>
              ...
              <div class="x_panel tile fixed_height_320 overflow_hidden">
                ...
                <div class="x_content">
                  <table class="" style="width:90%">
                      ...
                      <td>
                        <canvas class="canvasDoughnut" height="40" width="60" style="margin: 15px 10px 10px 0"></canvas>
                      </td>
                      <td>
                        <table class="tile_info">
                          <tr>
                            <td>
                              <p><i class="fa fa-square blue"></i>albandr </p>
                            </td>
                            <td>50%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square green"></i>al murjan </p>
                            </td>
                            <td>10%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square purple"></i>al naseem </p>
                            </td>
                            <td>20%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square aero"></i>al safa </p>
                            </td>
                            <td>15%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square red"></i>al amoudi </p>
                            </td>
                            <td>30%</td>
                          </tr>
                        </table>
